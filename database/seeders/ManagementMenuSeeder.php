    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'membawahi_menu_management_menu' => '3,4,5,6,7,8,9,10,11',
            ...
            [
                ...
                'nama_management_menu' => 'Kuisioner',
                'icon_management_menu' => 'far fa-circle',
                'link_management_menu' => '/admin/kuisioner',
                'membawahi_menu_management_menu' => '',
                'is_node_management_menu' => '',
            ],
            [
                ...
                'nama_management_menu' => 'Jawaban Kuisioner',
                'icon_management_menu' => 'far fa-circle',
                'link_management_menu' => '/admin/jawabanKuisioner',
                'membawahi_menu_management_menu' => '',
                'is_node_management_menu' => '',
            ],
            [
                ...
                'nama_management_menu' => 'Pernyataan',
                'icon_management_menu' => 'far fa-circle',
                'link_management_menu' => '/admin/pernyataan',
                'membawahi_menu_management_menu' => '',
                'is_node_management_menu' => '',
            ],
            [
                ...
                'nama_management_menu' => 'Range Bobot',
                'icon_management_menu' => 'far fa-circle',
                'link_management_menu' => '/admin/rangeBobot',
                'membawahi_menu_management_menu' => '',
                'is_node_management_menu' => '',
            ],
            [
            ...
            [
                ...
                'nama_management_menu' => 'Data Testing',
                'icon_management_menu' => 'book',
                'link_management_menu' => '/admin/dataTesting',
                'membawahi_menu_management_menu' => '',
                'is_node_management_menu' => '',
            ],
            [
                ...
                'nama_management_menu' => 'Hasil',
                'icon_management_menu' => 'user-check',
                'link_management_menu' => '/admin/hasil',
                'membawahi_menu_management_menu' => '',
                'is_node_management_menu' => '',
            ],
        ];
