             ...
             <form action="{{ route('admin.gallery.store') }}" class="form-submit">
                 ...
                 <div class="modal-body">
                     <div class="form-floating">
                         <input type="text" class="form-control nama_gallery" id="floatingInput"
                             placeholder="Nama gallery..." name="nama_gallery">
                         <small class="error_nama_gallery text-danger"></small>
                         <label for="floatingInput">Nama gallery</label>
                     </div>
                 </div>
