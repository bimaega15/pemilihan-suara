             ...
             <form action="{{ route('admin.banner.store') }}" class="form-submit">
                 ...
                 <div class="modal-body">
                     <div class="form-floating">
                         <input type="text" class="form-control nama_banner" id="floatingInput"
                             placeholder="Nama banner..." name="nama_banner">
                         <small class="error_nama_banner text-danger"></small>
                         <label for="floatingInput">Nama banner</label>
                     </div>
                 </div>
