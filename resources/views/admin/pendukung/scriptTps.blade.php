    ...
    $(document).ready(function() {
        ...
        function displayTps(data) {
            if (data.provinces != null) {
                ...
                $('#modalForm input.tps_id').val(tps.id);
                $('#modalForm span#provinces_id').html(tps.provinces.name);
                $('#modalForm span#districts_id').html(tps.regencies.name);
                $('#modalForm span#regencies_id').html(tps.districts.name);
                $('#modalForm span#villages_id').html(tps.villages.name);
                $('#modalForm span#alamat_tps').html(tps.alamat_tps);
            } else {
                $('#modalForm span#kuota_tps').html(data.kuota_tps);
