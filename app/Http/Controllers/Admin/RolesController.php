            ...
            return DataTables::eloquent($data)
                ->addColumn('action', function ($row) use ($userAcess) {
                    ...
                    if ($userAcess['is_update'] == '1') {
                        $buttonUpdate = '
                    <a href="' . route('admin.roles.edit', $row->id) . '" class="btn btn-outline-warning m-b-xs btn-edit" style="border-color: #f5af47ea !important;">
                    ...
                    if ($userAcess['is_delete'] == '1') {
                        $buttonDelete = '
                    <form action=' . route('admin.roles.destroy', $row->id) . ' class="d-inline">
